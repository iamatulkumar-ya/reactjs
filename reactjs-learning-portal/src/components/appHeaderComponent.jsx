...
// import reactPortalLogo from '../assets/images/logo/reactPortalLogo_small.svg'; 
    ...
    render(){
        return (
            ...
            <div className="content-width" style={{"display":"flex"}}> 
                    {/* <a href={AppUrl} >   */}
                        {/* <img src={reactPortalLogo}    className="App-logo" alt="logo" />    */}
                         <span className="App-heading">  {AppName}     Learning Portal   
                        </span>  
                    {/* </a>  */}
                ...
                {/* <div className="App-heading-div"> 
                    <span className="App-heading">  {AppName}  <br />
                        <span className="theme-color-text"> Learning Portal </span>  
                    </span> 
                </div>   */}
            </div>
            </div>

          ...
          <div style={{"background" :"white"}}>
                ...
                <div  className="content-width" > 
                   <div className="homePage-quotes-div">
                    <p> 
                        <q>This learning will make you understand the basics of <b> ReactJs</b> and help you to begin with it.</q>  
                    </p> 
                  </div> 

                  <div className="homePage-content-div row col-md-12 pd0">
                      <div className="homePage-content-card col-md-4">
                        <p className="hpcc-heading"> About Learning Portal</p>
